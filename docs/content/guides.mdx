...
| Name                                                                                                         | Description                                                                                                                   |
| ------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------- |
| [Software-Defined Assets for Existing Dagster Users](/guides/dagster/enriching-with-software-defined-assets) | This guide describes how to enrich what you've built in Dagster with software-defined assets.                                 |
